                                    ...
                                    <div class="mcb-wrap-inner">
                                       <div class="column mcb-column mcb-item-gb8yux6pn one-second column_column">
                                          <div class="column_attr clearfix" style="">
                                             <h2 style="color: #e7f4ff; line-height: 40px;font-size: 31px;">Experta en tratamiento de trauma psicológico y victimologia</h2>
                                          </div>
                                           <div class="column_attr clearfix" style="">
                                             <h2 style="color: #e7f4ff; line-height: 30px;font-size: 19px;font-weight: 500;font-style: italic;">Especialista en evaluaciones forenses para casos de inmigración</h2>
                                          </div>
                                       </div>
                                     </div>
                                </div>
                                                   ...
                                                   <a href="about.html">
                                                      <div class="hover_color_wrapper">
                                                         <div style="text-align: right; font-size: 20px; color: #ffffff; font-weight: 600;">
                                                            <i style="margin-right: 7px;" class="icon icon-right-circled"></i>Acerca de mi
                                                         </div>
                                                      </div>
                                                   </a>
                                                </div>
                                                         ...
                                                         <div class="mcb-wrap-inner">
                                                            <div class="column mcb-column mcb-item-uotdverad one column_column ">
                                                               <div class="column_attr clearfix align_right">
                                                                  <h3 style="display: inline-block; font-size: 40px; line-height: 45px; font-weight: 600; margin-right: 30px;letter-spacing: 2px;">¿Qué tanto anhelas escuchar?</h3>
                                                         ...
                                                         <div class="mcb-wrap-inner">
                                                            <div class="column mcb-column mcb-item-7h50ch4pv one column_column">
                                                               <div class="column_attr clearfix">
                                                                  <h3 style="display: inline-block; font-size: 37px; line-height: 45px; font-weight: 600; margin-right: 30px;letter-spacing: 1px;">Pero en cambio, lo que escuchas es</h3>
                                                                  <hr class="no_line" style="margin: 0 auto 0px;">
                                                                  <div style="height: 1px; background: #484a7d;"></div>
                                                               </div>
                                                            </div>
                                 ...
                                 <div class="section mcb-section" style="padding-top:95px; padding-bottom:60px; background-image:url(images/section-md.png); background-repeat:no-repeat; background-position:right top">
                                    ...
                                    <div class="column_attr clearfix align_center">
                                       <h2 style="font-size: 48px;line-height: 80px;letter-spacing: 0.123em;font-style: italic; ">
                                          Estoy segura de que te has sentido
                                       </h2>
                                             ...
                                             <div class="animate fadeInLeft" data-anim-type="fadeInLeft">
                                                <div class="icon_box icon_position_top no_border">
                                                      ...
                                                      <div class="desc_wrapper">
                                                         <p class="title"></p>
                                                         <div class="desc">
                                                            <p style="display: inline-block; font-size: 19px; line-height: 30px; line-he_letter-spacing: 0.036em; font-weight: 500;">
                                                      ...
                                                      <div class="col-sm">
                                                         <div class="section_wrapper">
                                                            <div class="fancy_heading fancy_heading_arrows">
                                                               <h2 class="title font-size: 48px; line-height: 50px"><i class="revicon-right-open-1"></i>Me imagino que...<i class="revicon-left-open-1"></i></h2>
                                                               <div class="inside">
                                                                  <p style="display: inline-block; color: #E1DEDE margin: 0;  font-size: 22px; line-height: 34px; line-he_letter-spacing: 0.036em;font-style: italic;">
                                 ...
                                 <div class="container">
                                    <div class="row">
                                       <div class="col-sm">
                                          ...
                                          <p style="display: inline-block; color: #512a8a; margin: 0;  font-size: 22px; line-height: 34px; line-he_letter-spacing: 0.036em; font-weight: 500;letter-spacing: 0.01em;text-align: center !important;">
                                             ¿Te gustaría aprender sobre la vergüenza de las y los sobrevivientes y cómo lidiar con este desagradable sentimiento?.
                                          </p>
                                          <a href="suscribete-1.html"  target="_blank" rel="nofollow">   
                                       ...
                                       <div class="col-sm">
                                          ...
                                          <p style="display: inline-block; color: #512a8a; margin: 0;  font-size: 21px; line-height: 34px; line-he_letter-spacing: 0.036em; font-weight: 500;letter-spacing: 0.023em;text-align: center !important;">
